...
<!--TABLEAU RETOUR NORMAL -->
<div id="rdvNormal" class="retourNormal">
<?php
//On récupère les données pour le tableau liste RDV normal
...
AND E.DateRetourSouhaite is NOT NULL
ANd E.DateRetourSouhaite = DATE( NOW() )
AND E.DateRetourReel is NULL');

    echo"<h1>Rendez-vous du jour</h1>";
    ...
    <section class=afficher_users>";
        ...
        echo "</tr>\n";
            ...
            while ($user = $pret->fetch()) {
                ++$i;
                echo '<tr class="select"  id="'.$i.'" onclick="recupID2(this)">';
...
<div id="boutton">
    <a class="valid-button" href="receptionmaturgent.php" id="retourUrgent">Retour urgent</a>
</div>
...
<?php
    ...
    echo"<input type='submit' class='valid-button' id='button3' name='valider' value='VALIDER'>";
    echo"<input type='reset' class='return-button' id='button3' value='ANNULER' onclick='reload()';>";
    echo"</div>" ;
    echo "</form>";
...
function reload(){
  window.location.href="receptionmatnormal.php";
}
</script>
